...
With Define Me, you can look up a word by typing it into the command line. The script retrieves the definition from [Wordnik](https://www.wordnik.com/) and stores it in a database table. Before running the script, you'll have to sign up for a [Wordnik
